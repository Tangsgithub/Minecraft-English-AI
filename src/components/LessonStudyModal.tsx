      ...
      <div className="bg-white border-2 sm:border-4 border-[#487E2C] rounded-2xl sm:rounded-[2.5rem] w-full max-w-3xl text-[#2D2D2D] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.2)] sm:shadow-[12px_12px_0px_0px_rgba(0,0,0,0.2)] overflow-hidden my-auto max-h-[92dvh] flex flex-col">
        ...
        <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 overflow-y-auto flex-1">
          ...
          <div className="bg-slate-50 p-4 sm:p-5 rounded-2xl border-2 border-slate-200 space-y-3">
            <h3 className="text-xs font-mono font-black text-[#487E2C] uppercase tracking-wider flex items-center justify-between">
              <span>🎭 原版课文对话练习</span>
              ...
              {lesson.dialogueScript.map((turn, index) => {
                ...
                return (
                  <div key={index} className="flex items-start space-x-3 text-xs">
                    ...
                    <div className={`flex-1 p-3 rounded-2xl border-2 shadow-sm transition-colors ${isPlayed ? 'bg-green-50 border-green-200' : 'bg-white border-slate-200'}`}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg border transition-colors ${isPlayed ? 'bg-[#487E2C] text-white border-black' : 'bg-slate-100 text-slate-500 hover:text-[#487E2C] border-slate-300'}`}
                        >
